...
<div className=" flex px-5 text-base flex-row w-full border-b-0">
    <div className="">
    <div className='mt-24 px-12 py-3 w-fit  bg-gray-200 rounded-3xl font-semibold text-white cursor-pointer'>
    Influence
</div>
...
<div className="flex flex-row my-32 gap-52 justify-center mx-auto aria-label max-w-7xl w-full h-auto">
    <div className="img  bg-blue-950 ml-14 p-56 h-56  rounded-xl"></div>
    <div className=" flex flex-col justify-center w-full pt-10 gap-3   ">
        ...
        <div className="py-20 w-4/5 bg-black rounded-3xl"></div>
    </div>
</div>
        <Footer/>
        </div>
