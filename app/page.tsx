...
export default function Home() {
  return (
    <>
      <Header />
      <section className="homepage max-w-7xl mx-auto aria-label overflow-x-hidden h-lvl bg-white font-Outfit box-border  ">
        <div className="flex max-w-8xl flex-col md:flex-row px-4 md:px-16 text-base border-b-0">
          <div className="md:w-2/3 pt-16 items-center h-fit bg-white">
            <h1 className="text-black text-4xl md:text-5xl font-black leading-tight md:leading-normal">
              Join a <span className="text-blue-700">Circle </span> that <br /> allows you
            ...
            </h1> <Shade className='absolute top-[13rem] left-56'/>
            <p className="text-gray-500 pt-5 text-3xl md:text-xl">
        ...
        <div className="feature grid items-start justify-center w-full md:h-48 pt-20 md:pt-20 mb-10">
          <h2 className="text-black text-center font-bold text-lg md:text-xl">
            Featured In
          </h2>
          <div className="fet flex">
            <Image
              src={Sift}
              className="mr-3"
              height={40}
      ...
      <section>
        <div className="thirdnav max-w-7xl mx-auto aria-label h-full w-full bg-white">
          ...
          <div className="tab h-auto md:h-[32rem] mt-12 items-end flex flex-col md:flex-row gap-4 justify-center">
            <div className="relative bg-homeash h-auto p-6  md:h-80 w-full md:w-1/3 rounded-2xl mb-4 md:mb-0">
            ...
            <div className="bg-homeblue relative px-5 py-10 h-auto md:h-full w-full md:w-1/3 rounded-2xl">
              <h2 className="text-lg pb-3 text-white md:text-xl font-bold">
                Save
              </h2>
              <p className="text-sm text-white md:text-base">
                Create and join multiple accountable savings group to earn more
                than 15% on annual intrest rate.
              </p>
            ...
            <div className="bg-homeash   relative h-auto p-6 md:h-80 w-full md:w-1/3 rounded-2xl">
              <h2 className="text-lg pb-3 md:text-xl font-bold">Spend</h2>
              <p className="text-sm text-brandblack md:text-base">
                Checkout with my Circle wallet creates an autosave lifestyle.
                Save on discounts that automatically create savings.
              ...
              />
              <h1 className=" flex absolute right-8 bottom-8 hover:scale-200 hover:cursor-pointer text-getstarted">
                Get Started
                <span className="ml-2">
                  <ArrowUp />
                </span>
      ...
      <section>
        <div className="max-w-7xl mx-auto aria-label socialize flex justify-center gap-5 my-28 ">
      ...
      <section className="Business">
        <div className="max-w-7xl mx-auto flex mb-16 gap-5">
          <div className=" h-96 w-[30rem] bg-homepink rounded-2xl">
            <Image src={Stack} height={500} width={500} alt="" />
          </div>
          <div className=" h-96 w-full py-10 px-7 bg-homelightpink gap-6 rounded-2xl">
            <div className="  px-4 w-24 py-2 text-center rounded-xl font-semibold text-homeblue border-blue-700 border bg-slate-300">
              Business
            </div>
            <h1 className="text-lg md:text-4xl font-black mt-7">
      ...
      <section className="bg-homelightpurple">
        <div className="max-w-7xl mx-auto flex flex-col items-start security h-full pb-20 ">
          ...
          <div className="text-black text-3xl mb-6 font-extrabold">
      ...
      <section>
        <div className="max-w-7xl mx-auto flex flex-col items-start h-fit pb-8">
          ...
          <div className="flex w-full h-auto overflow-x-auto rounded-2xl flex-row gap-8">
            <div className="w-1/4 shrink-0 grow-0 flex flex-col relative pt-32 h-96 rounded-2xl bg-homeash">
      ...
      <section className="flexible fonts[Outfit]  h-[35rem] overflow-hidden bg-black font-Outfit box-border  ">
        <div className="max-w-7xl mx-auto flex px-16 text-base flex-row w-full border-b-0">
          <div className="pt-32 items-center w-2/4 h-fit bg-black">
