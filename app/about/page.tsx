    ...
    return (
        <>
            ...
            <div  aria-label="Global" className=" overflow-hidden bg-white box-border ">
                    ...
                    <div className="flex flex-col md:flex-row md:gap-16 md:justify-center">
                        <div className="p-8 flex flex-col justify-center md:px-24 rounded-2xl bg-aboutgray">
                        ...
                        <div className="p-8 flex flex-col justify-center md:px-24 rounded-2xl bg-aboutgreen">
                        <div className="">
                        <div className=" h-48 w-48 mb-8  rounded-full ">
                        <Image 
                            src={Larry} 
