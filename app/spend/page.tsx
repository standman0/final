...
export default function Spend () {
    ...
    return(
        ...
        <div className="max-w-7xl flex-col md:flex-row mx-auto aria-label h-full lg:h-[20rem] flex lg:flex-row lg:rounded-xl bg-spendlblue ">
        <div className="grid justify-items-center text-center w-full pt-6 lg:w-1/3 mb-6 h-full">
  <div className="flex flex-col text-left pl-6  lg:pl-16 justify-center">
    <Ball/>
    <h1 className='text-xl font-bold pt-7 text-homeblue '>Expense</h1>
    <p className='text-neutral-500 md:text-sm leading-7 tracking-wide'>Leverage your expense to create savings for you. Eat, shop, drink and flex as you save</p>
  </div>
</div>

        <div className="  grid justify-items-center w-full pt-6 text-center mb-6 lg:w-1/3  h-full ">
            <div className="flex flex-col text-left lg:pl-16 pl-6 justify-center">
            <Ball/>
                <h1 className='text-xl font-bold pt-7 text-homeblue '>Discount</h1>
                <p className='text-neutral-500  md:text-sm leading-7 tracking-wide'>As you spend, you earn as high as 30% in discount that auto saves in your wallet</p>
            </div>
        </div>

        <div className=" grid justify-items-center w-full text-center lg:w-1/3 pt-6  h-full ">
            ...
            <Ball/>
                ...
                <p className='text-neutral-500 md:text-sm leading-7 tracking-wide'>Your discount also earns interest and this is available to spend or withdraw every 30 days</p>
            </div>
        </div>
         </div>
         <div className="w-fit max-w-7xl mx-auto aria-label md:my-9 md:flex-row my-16 h-[49rem] md:h-[26rem]  lg:h-[32rem] flex flex-col lg:flex-row lg:rounded-xl bg-spendblue">
            <div className="img w-full md:w-1/2 lg:w-1/2 h-[20rem] mb:h-full">
            <Image
                        width={1000}
                        height={1000}
                        src={Bank}
                        alt=''
                        className='object-cover md:h-[26rem] h-[20rem] lg:h-[32rem] '
                        />
            </div>
