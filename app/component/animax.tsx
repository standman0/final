...
const AnimationComponent: React.FC = () => {
    ...
    return (
        <div className="animax max-w-xl w-full md:h-[30rem]  lg:h-[30rem] relative aria-label overflow-hidden ">
            ...
            <Line1 className='line1 absolute left-[10.9rem]  top-[10rem] '/>
            <Line2 className='line2 absolute left-[10.9rem]  top-[10rem] '/>
            <Middleman className='absolute left-[14rem]  top-[9.5rem] ' />
            <First className='first absolute left-[24rem] top-[13rem]'/>
            <Second className='second absolute w-1/2 left-[5rem]  top-[2rem] '/>
            <Third className='third absolute  left-[24rem] top-[2rem]'/>
            <Last className='last absolute top-[13rem] left-[5rem] '/>
        </div>
    );
};
